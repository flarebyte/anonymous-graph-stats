  ...
  it('count attributes', () => {
    ...
    const expected = {
      ...
      values: [
        ...
        { name: 'nodes value chars min', value: 3 },
        { name: 'nodes value chars max', value: 6 },
        { name: 'nodes value chars median', value: 4.5 },
        { name: 'nodes value chars quartile first', value: 3.75 },
        { name: 'nodes value chars quartile third', value: 5.25 },
        { name: 'nodes value words min', value: 1 },
        { name: 'nodes value words max', value: 1 },
        { name: 'nodes value words median', value: 1 },
        { name: 'nodes value charpage 1', value: 4 },
        { name: 'nodes value charpage 2', value: 14 },
        { name: 'edges value chars min', value: 2 },
        { name: 'edges value chars max', value: 3 },
        { name: 'edges value chars median', value: 3 },
        { name: 'edges value chars quartile first', value: 2 },
        { name: 'edges value chars quartile third', value: 3 },
        { name: 'edges value words min', value: 1 },
        { name: 'edges value words max', value: 1 },
        { name: 'edges value words median', value: 1 },
        { name: 'edges value charpage 1', value: 13 },
        { name: 'nodes optionalValueList chars min', value: 1 },
        { name: 'nodes optionalValueList chars max', value: 4 },
        { name: 'nodes optionalValueList chars median', value: 3 },
        { name: 'nodes optionalValueList chars quartile first', value: 2 },
        {
          name: 'nodes optionalValueList chars quartile third',
          value: 3.5,
        },
        { name: 'nodes optionalValueList words min', value: 1 },
        { name: 'nodes optionalValueList words max', value: 1 },
        { name: 'nodes optionalValueList words median', value: 1 },
        { name: 'nodes optionalValueList charpage 125', value: 2 },
        { name: 'nodes optionalValueList charpage 126', value: 2 },
        { name: 'nodes optionalValueList charpage 273', value: 1 },
        { name: 'nodes optionalValueList charpage 349', value: 1 },
        { name: 'nodes optionalValueList charpage 366', value: 1 },
        { name: 'nodes optionalValueList charpage 392', value: 1 },
        { name: 'edges optionalValueList chars min', value: 2 },
        { name: 'edges optionalValueList chars max', value: 2 },
        { name: 'edges optionalValueList chars median', value: 2 },
        { name: 'edges optionalValueList chars quartile first', value: 2 },
        { name: 'edges optionalValueList chars quartile third', value: 2 },
        { name: 'edges optionalValueList words min', value: 1 },
        { name: 'edges optionalValueList words max', value: 1 },
        { name: 'edges optionalValueList words median', value: 1 },
        { name: 'edges optionalValueList charpage 1286', value: 3 },
      ],
    };
    expect(actual).toEqual(expected);
  });
